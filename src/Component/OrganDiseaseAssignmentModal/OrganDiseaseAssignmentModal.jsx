            ...
            <Spin spinning={loading}>
                <div style={{ display: 'flex', gap: '24px', maxHeight: '70vh' }}>
                    ...
                    <div style={{ flex: 1 }}>
                        ...
                        <div style={{ maxHeight: '50vh', overflowY: 'auto', border: '1px solid #f0f0f0', borderRadius: '8px', padding: '12px' }}>
                            {assignedItems.length === 0 ? (
                                ...
                                assignedItems.map(item => (
                                    <div
                                        ...
                                        style={{
                                            ...
                                            borderRadius: '6px',
                                            marginBottom: '8px',
                                            backgroundColor: selectedAssignedItemIds.includes(item.id) ? '#ffe6e6' : '#f9f9f9',
                                            cursor: 'pointer',
                                        }}
                                        onClick={() =>
                                    ...
                                    >
                                        <div style={{ display: 'flex', alignItems: 'start' }}>
                                            <Checkbox checked={selectedAssignedItemIds.includes(item.id)} style={{ marginRight: '12px', marginTop: '2px' }} />
                                            <Text strong style={{ color: '#004c78' }}>{item.name}</Text>
                                        </div>
                                    </div>
                                ))
                            )}
                    ...
                    <div style={{ flex: 1 }}>
                        ...
                        />
                        <div style={{ maxHeight: '45vh', overflowY: 'auto', border: '1px solid #f0f0f0', borderRadius: '8px', padding: '12px' }}>
                            {filteredAvailable.length === 0 ? (
                                <div style={{ textAlign: 'center', padding: '40px 0', color: '#999' }}>
                                    {searchText ? `No ${oppositeEntity} matching your search` : `No ${oppositeEntity} available`}
                                </div>
                            ) : (
                                filteredAvailable.map(item => (
                                    <div
                                        ...
                                        style={{
                                            ...
                                            borderRadius: '6px',
                                            marginBottom: '8px',
                                            backgroundColor: selectedAvailableItemIds.includes(item.id) ? '#e6f7ff' : '#fff',
                                            cursor: 'pointer',
                                        }}
                                        onClick={() =>
                                    ...
                                    >
                                        <div style={{ display: 'flex', alignItems: 'start' }}>
                                            <Checkbox checked={selectedAvailableItemIds.includes(item.id)} style={{ marginRight: '12px', marginTop: '2px' }} />
                                            <Text strong style={{ color: '#004c78' }}>{item.name}</Text>
                                        </div>
                                    </div>
                                ))
